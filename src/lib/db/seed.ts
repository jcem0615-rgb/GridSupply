...
const CATALOG: CatalogItem[] = [
  item('Bond Paper A4', 'Substance 20', 'ream', 210, 18, 500, 240, 40),
  item('Bond Paper Long', 'Substance 20', 'ream', 245, 18, 500, 180, 40),
  item('Whiteboard Marker', 'Refillable, black', 'box', 320, 22, 12, 64, 12),
  item('Manila Paper', 'Assorted colours', 'pack', 85, 25, 20, 30, 10),
  item('Chalk, Dustless', 'White', 'box', 145, 20, 100, 8, 10),
  item('Ballpen, Black', 'Fine point', 'box', 260, 20, 50, 96, 20),
  item('Printer Ink 003 Black', 'Compatible refill, 65ml', 'bot', 380, 15, 0, 22, 8),
  item('Storage Box, 60L', 'Heavy duty with lid', 'unit', 690, 17, 0, 14, 5),
  item('Alcohol 70% Ethyl', '500ml', 'bot', 78, 24, 0, 150, 30),
  item('Trash Bag, XL', 'Black', 'pack', 320, 20, 100, 4, 10),
  item('Cartolina, Assorted', 'Assorted colours', 'pack', 110, 25, 20, 45, 10),
  item('Folder, Long', 'Manila', 'pack', 340, 19, 100, 0, 6),
]
